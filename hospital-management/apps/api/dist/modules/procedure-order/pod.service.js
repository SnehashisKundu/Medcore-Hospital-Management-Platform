...
exports.createProcedureOrder = createProcedureOrder;
exports.getProcedureOrders = getProcedureOrders;
exports.getProcedureOrderById = getProcedureOrderById;
exports.updateProcedureOrder = updateProcedureOrder;
const prisma_1 = require("../../config/prisma");
async function createProcedureOrder(input) {
    ...
    const orderedBy = await prisma_1.prisma.user.findUnique({
        where: {
    ...
    if (input.admissionId) {
        ...
        if (admission.patientId !== encounter.patientId) {
            throw new Error("ADMISSION_ENCOUNTER_MISMATCH");
        }
    ...
    return prisma_1.prisma.procedureOrder.create({
        data: {
...
async function getProcedureOrders() {
    return prisma_1.prisma.procedureOrder.findMany({
        include: {
            encounter: {
                select: {
                    id: true,
...
async function getProcedureOrderById(id) {
...
async function updateProcedureOrder(id, input) {
    const procedureOrder = await prisma_1.prisma.procedureOrder.findUnique({
        where: {
            id,
        },
    ...
    if (procedureOrder.status === "COMPLETED" ||
        ...
        throw new Error("PROCEDURE_ORDER_NOT_MODIFIABLE");
    }
    ...
    return prisma_1.prisma.procedureOrder.update({
        where: {
            id,
        },
        data: updateData,
