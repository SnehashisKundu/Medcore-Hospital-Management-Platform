...
const ba_controller_1 = require("./ba.controller");
 ...
 */
router.post("/", auth_middleware_1.authenticate, (0, permission_middleware_1.requirePermission)("BED_ALLOCATION_CREATE"), ba_controller_1.allocateBedController);
/**
 * @swagger
 * /api/v1/bed-allocations:
 *   get:
 ...
 *         description: Internal server error
 */
router.get("/", auth_middleware_1.authenticate, (0, permission_middleware_1.requirePermission)("BED_ALLOCATION_READ"), ba_controller_1.getBedAllocationsController);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get("/admission/:admissionId", auth_middleware_1.authenticate, (0, permission_middleware_1.requirePermission)("BED_ALLOCATION_READ"), ba_controller_1.getBedAllocationsController);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get("/bed/:bedId", auth_middleware_1.authenticate, (0, permission_middleware_1.requirePermission)("BED_ALLOCATION_READ"), ba_controller_1.getBedAllocationsController);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get("/admissionId=:admissionId", auth_middleware_1.authenticate, (0, permission_middleware_1.requirePermission)("BED_ALLOCATION_READ"), ba_controller_1.getBedAllocationsController);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get("/bedId=:bedId", auth_middleware_1.authenticate, (0, permission_middleware_1.requirePermission)("BED_ALLOCATION_READ"), ba_controller_1.getBedAllocationsController);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.put("/:id/release", auth_middleware_1.authenticate, (0, permission_middleware_1.requirePermission)("BED_ALLOCATION_UPDATE"), ba_controller_1.releaseBedController);
