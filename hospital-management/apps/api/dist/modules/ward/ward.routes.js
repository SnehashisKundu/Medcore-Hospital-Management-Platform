 ...
 */
router.post("/", auth_middleware_1.authenticate, (0, permission_middleware_1.requirePermission)("WARD_CREATE"), ward_controller_1.createWardController);
/**
 * @swagger
 * /api/v1/wards:
 *   get:
 ...
 *         description: Internal server error
 */
router.get("/", auth_middleware_1.authenticate, (0, permission_middleware_1.requirePermission)("WARD_READ"), ward_controller_1.getWardsController);
/**
 * @swagger
 * /api/v1/wards/{id}:
 *   get:
 ...
 *         description: Internal server error
 */
router.get("/:id", auth_middleware_1.authenticate, (0, permission_middleware_1.requirePermission)("WARD_READ"), ward_controller_1.getWardByIdController);
/**
 * @swagger
 * /api/v1/wards/{id}:
 *   put:
 ...
 *         description: Internal server error
 */
router.put("/:id", auth_middleware_1.authenticate, (0, permission_middleware_1.requirePermission)("WARD_UPDATE"), ward_controller_1.updateWardController);
/**
 * @swagger
 * /api/v1/wards/{id}:
 *   delete:
 ...
 *         description: Internal server error
 */
router.delete("/:id", auth_middleware_1.authenticate, (0, permission_middleware_1.requirePermission)("WARD_DELETE"), ward_controller_1.deleteWardController);
