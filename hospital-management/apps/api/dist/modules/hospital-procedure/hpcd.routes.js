...
const hpcd_controller_1 = require("./hpcd.controller");
 ...
 */
router.post("/", auth_middleware_1.authenticate, (0, permission_middleware_1.requirePermission)("HOSPITAL_PROCEDURE_CREATE"), hpcd_controller_1.createHospitalProcedureController);
/**
 * @swagger
 * /api/v1/hospital-procedures:
 *   get:
 ...
 *         description: Internal server error
 */
router.get("/", auth_middleware_1.authenticate, (0, permission_middleware_1.requirePermission)("HOSPITAL_PROCEDURE_READ"), hpcd_controller_1.getHospitalProceduresController);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get("/:id", auth_middleware_1.authenticate, (0, permission_middleware_1.requirePermission)("HOSPITAL_PROCEDURE_READ"), hpcd_controller_1.getHospitalProcedureByIdController);
/**
 * @swagger
 * /api/v1/hospital-procedures/{id}:
 *   put:
 ...
 *         description: Internal server error
 */
router.put("/:id", auth_middleware_1.authenticate, (0, permission_middleware_1.requirePermission)("HOSPITAL_PROCEDURE_UPDATE"), hpcd_controller_1.updateHospitalProcedureController);
/**
 * @swagger
 * /api/v1/hospital-procedures/{id}:
 *   delete:
 ...
 *         description: Internal server error
 */
router.delete("/:id", auth_middleware_1.authenticate, (0, permission_middleware_1.requirePermission)("HOSPITAL_PROCEDURE_DELETE"), hpcd_controller_1.deleteHospitalProcedureController);
