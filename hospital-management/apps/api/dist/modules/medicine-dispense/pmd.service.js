...
exports.createMedicineDispense = createMedicineDispense;
exports.getMedicineDispenses = getMedicineDispenses;
exports.getMedicineDispenseById = getMedicineDispenseById;
const prisma_1 = require("../../config/prisma");
async function createMedicineDispense(input) {
    ...
    const pharmacist = await prisma_1.prisma.user.findUnique({
        where: {
...
async function getMedicineDispenses() {
    return prisma_1.prisma.medicineDispense.findMany({
        include: {
            items: true,
            prescription: {
                include: {
...
async function getMedicineDispenseById(id) {
    const dispense = await prisma_1.prisma.medicineDispense.findUnique({
        where: {
            id,
        },
        include: {
